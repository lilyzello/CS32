...
void Rabbit::move()
{
    //If the rabbit starts its turn posisioned but alive (i.e. it has a health equal to 1) at a gridpoint, the record function is called and arena's history object is updated
    if (m_health == 1)
    {
